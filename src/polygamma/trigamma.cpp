/**
 * @file trigamma.cpp
 * Provides an implementation of the trigamma function, which
 * is defined as the 2nd derivative of the log gamma function.
 ...
 * BE Schneider. Library Interface and description modified by Luke Teacy.
...
//
double polygamma::trigamma ( double x, int *ifault )
{
  using namespace std;
  double a = 0.0001;
  double b = 5.0;
