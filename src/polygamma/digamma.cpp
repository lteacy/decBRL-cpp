/**
 * @file digamma.cpp
 * Provides an implementation of the digamma functions, which
 * is defined as the 1st derivative of the log gamma function.
 ...
 * Jose Bernardo. Library Interface modified by Luke Teacy.
...
//
double polygamma::digamma ( double x, int *ifault )
{
  using namespace std;
  double c = 8.5;
...
//
void polygamma::psi_values ( int *n_data, double *x, double *fx )
{
# define N_MAX 11
